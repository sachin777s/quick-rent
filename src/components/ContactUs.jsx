    ...
    return (
      <section id="contact" className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[var(--main-color)] text-center mb-6">Contact Us</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Map or Office Location Placeholder */}
            <div className="h-full rounded-lg shadow-lg overflow-hidden">
              {/* Replace the iframe below with an actual map embed link */}
              <iframe
