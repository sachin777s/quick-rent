const GadgetListing = () => {
  const gadgets = [
    ...
    },
    {
      ...
      image:
        "https://cdn.pixabay.com/photo/2021/09/25/17/43/iphone-13-6655517_640.jpg",
    },
  ];
    ...
    <section id="gadgets" className="py-16 bg-gray-100">
      <div className="text-center space-y-6">
        <h2 className="text-3xl font-extrabold text-[var(--main-color)]">
          Available Gadgets for Rent
        </h2>
        <p className="text-lg text-gray-700">
          Discover top-notch gadgets tailored to your needs!
        </p>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-6 lg:px-8">
        {gadgets.map((gadget, index) => (
          ...
          >
            ...
            />
            <h3 className="text-2xl font-semibold text-[var(--main-color)] mb-2">
              {gadget.name}
            </h3>
            ...
            <button className="w-full py-2 px-4 bg-[var(--main-color)] text-white font-semibold rounded-md transition-all duration-300 hover:bg-[var(--hover-color)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--main-color)] active:scale-95">
              Rent Now
            </button>
          </div>
        ))}
